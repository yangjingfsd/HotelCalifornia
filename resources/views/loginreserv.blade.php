            ...
            <table id="guest-info" style='border-collapse:separate;border-spacing:3px;'>
                <tr>
                    ...
                    <td>
                        <input type="text" id="first-name" name='firstname' size="30" maxlength="15" autofocus="autofocus"
                            required="required" value="{{ $_GET['firstname'] }}"> <span><sup>*</sup></span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" id="last-name" name='lastname' size="30" maxlength="15" required="required"  value="{{ $_GET['lastname'] }}">
                        <span><sup>*</sup></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        value="{{ $_GET['email'] }}" readonly><span><sup>*</sup></span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                            required="required"  value="{{ $_GET['phone'] }}" size="30">
                    </td>
                </tr>
